...
- Fixed a crash when displaying through-wall texture and item billboards with Improved Transparency enabled.
...
- Fixed Forge mods using Amber failing to receive client packets on dedicated servers.
...
- Fixed `EntityEvent.AFTER_DAMAGE` on Forge and NeoForge across Minecraft 1.21.11, 26.1, 26.1.1, 26.1.2, and 26.2.
