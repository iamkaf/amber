...
final class ForgeAmberEventHandlers {
    ...
    static public class EventHandlerCommon {
        ...
        public static void onCommandRegistration(RegisterCommandsEvent event) {
	        ...
	        private static net.minecraft.util.registry.DynamicRegistries legacyBuiltinRegistryAccess() {


	            return net.minecraft.util.registry.DynamicRegistries.builtin();
	        }

	        private static net.minecraft.command.Commands.EnvironmentType commandSelectionAll() {
	            return java.lang.Enum.valueOf(net.minecraft.command.Commands.EnvironmentType.class, "ALL");
	        }
        ...
        public static boolean onLivingAttack(LivingAttackEvent event) {
            ...
            ActionResultType result = EntityEvent.ENTITY_DAMAGE.invoker()
                    .onEntityDamage(
        ...
        private static void fireLegacyShieldBlock(LivingAttackEvent event) {
            if (!(event.getEntityLiving() instanceof net.minecraft.entity.player.PlayerEntity player)) {
                return;
            }
        ...
        private static boolean legacyIsDamageSourceBlocked(net.minecraft.entity.player.PlayerEntity player, net.minecraft.util.DamageSource source) {
        ...
        private static boolean legacyIsShieldItem(Item item) {
            return item instanceof net.minecraft.item.ShieldItem;
        }


        public static boolean onBlockBreak(BlockEvent.BreakEvent event) {
            ActionResultType result = BlockEvents.BLOCK_BREAK_BEFORE.invoker().beforeBlockBreak(
        ...
        public static boolean onBlockPlace(BlockEvent.EntityPlaceEvent event) {
            ...
            ActionResultType result = BlockEvents.BLOCK_PLACE.invoker()
        ...
        public static boolean onBlockInteract(PlayerInteractEvent.RightClickBlock event) {
            ActionResultType result = BlockEvents.BLOCK_INTERACT.invoker()
        ...
        public static boolean onBlockClick(PlayerInteractEvent.LeftClickBlock event) {
            ActionResultType result = BlockEvents.BLOCK_CLICK.invoker()
                    .onBlockClick(
        ...
        public static void onPlayerJoin(PlayerEvent.PlayerLoggedInEvent event) {
            if (event.getEntity() instanceof net.minecraft.entity.player.ServerPlayerEntity serverPlayer) {
        ...
        public static void onPlayerRespawn(PlayerEvent.PlayerRespawnEvent event) {
            if (event.getEntity() instanceof net.minecraft.entity.player.ServerPlayerEntity newPlayer) {
        ...
        public static boolean onAnimalTame(AnimalTameEvent event) {
            ...
            ActionResultType result = AnimalEvents.ANIMAL_TAME.invoker().onAnimalTame(event.getAnimal(), event.getTamer());
            return result != ActionResultType.PASS;
        }

        public static void onAnimalBreed(BabyEntitySpawnEvent event) {
            if (event.getParentA() instanceof net.minecraft.entity.passive.AnimalEntity parentA && event.getParentB() instanceof net.minecraft.entity.passive.AnimalEntity parentB) {
        ...
        public static void onItemCrafted(PlayerEvent.ItemCraftedEvent event) {
            if (event.getPlayer() instanceof net.minecraft.entity.player.ServerPlayerEntity serverPlayer) {
        ...
        public static void onWorldSave(WorldEvent.Save event) {
	        ...
	        private static net.minecraft.server.MinecraftServer legacyServer(Object level) {
	            return ((net.minecraft.world.World) level).getServer();
	        }

	        private static boolean legacyIsClientSide(net.minecraft.entity.Entity entity) {
    ...
    static public class EventHandlerClient {
        ...
        public static void onMouseScroll(InputEvent.MouseScrollEvent event) {
            ActionResultType result = InputEvents.MOUSE_SCROLL_PRE.invoker()
        ...
        public static void onBlockOutlineRender(
            ...
            ActionResultType result = RenderEvents.BLOCK_OUTLINE_RENDER.invoker().onBlockOutlineRender(
