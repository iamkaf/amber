...
public final class WorldFunctions {
     ...
     *
     * @param level The level to check. Must be a WorldGenLevel.
     * @param position The position to check difficulty at.
     * @return The difficulty instance at the position.
     */
    public static DifficultyInstance getCurrentDifficulty(WorldGenLevel level, BlockPos position) {
     ...
     * @return The difficulty instance at the position.
     */
    public static DifficultyInstance getCurrentDifficulty(WorldGenLevel level, Vec3 position) {
     ...
     */
    public static boolean isHardDifficulty(WorldGenLevel level, BlockPos position) {
     ...
     * @return true if difficulty is hard or harder, false otherwise.
     */
    public static boolean isHardDifficulty(WorldGenLevel level, Vec3 position) {
        return getCurrentDifficulty(level, position).getDifficulty() == Difficulty.HARD;
    }
