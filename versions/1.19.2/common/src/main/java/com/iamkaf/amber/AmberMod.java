...
public class AmberMod {
    ...
    public static DeferredRegister<Item> ITEMS = DeferredRegister.create(Constants.MOD_ID, Registry.ITEM_REGISTRY);
    public static RegistrySupplier<Item> TEST_ITEM =
            ITEMS.register("test_item", (key) -> new Item(new Item.Properties()));
