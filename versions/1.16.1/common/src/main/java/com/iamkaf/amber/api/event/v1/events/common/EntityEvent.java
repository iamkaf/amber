...
public class EntityEvent {
    ...
    public static final class SimpleShearingContext implements ShearingContext {
        private final @Nullable net.minecraft.server.level.ServerPlayer player;
        private final ItemStack shears;
        private final Entity targetEntity;
        private final Level level;
        private final ShearTarget targetType;
        private final List<ItemStack> drops;
        private final boolean successful;
        private final ShearSource source;
        ...
        private static List<ItemStack> copyDrops(List<ItemStack> sourceDrops) {
            List<ItemStack> copies = new ArrayList<ItemStack>(sourceDrops.size());
