...
public final class WorldFunctions {
     ...
     */
    public static void playSoundAt(Level level, Vec3 position, SoundEvent sound) {
     ...
     */
    public static void playSoundAt(Level level, Vec3 position, SoundEvent sound, SoundSource source) {
     ...
     */
    public static void playSoundAt(Level level, Vec3 position, SoundEvent sound, SoundSource source, float volume) {
     ...
     */
    public static void playSoundAt(Level level, Vec3 position, SoundEvent sound, SoundSource source, float volume, float pitch) {
     ...
     * @param source The sound source category.
     */
    public static void playSoundAt(Level level, BlockPos position, SoundEvent sound, SoundSource source) {
     ...
     * @param pitch The pitch multiplier (1.0 = normal pitch).
     */
    public static void playSoundAt(Level level, BlockPos position, SoundEvent sound, SoundSource source, float volume, float pitch) {
     ...
     *
     * @param level The level to check. Must be a LevelAccessor.
     * @param position The position to check difficulty at.
     * @return The difficulty instance at the position.
     */
    public static DifficultyInstance getCurrentDifficulty(LevelAccessor level, BlockPos position) {
     ...
     * @return The difficulty instance at the position.
     */
    public static DifficultyInstance getCurrentDifficulty(LevelAccessor level, Vec3 position) {
        return level.getCurrentDifficultyAt(blockPos(position));
    }
     ...
     */
    public static boolean isHardDifficulty(LevelAccessor level, BlockPos position) {
     ...
     * @return true if difficulty is hard or harder, false otherwise.
     */
    public static boolean isHardDifficulty(LevelAccessor level, Vec3 position) {
        return getCurrentDifficulty(level, position).getDifficulty() == Difficulty.HARD;
    }
    ...
    public static List<Player> getPlayers(Level level) {
        ...
        } else if (level instanceof net.minecraft.client.multiplayer.MultiPlayerLevel) {
            net.minecraft.client.multiplayer.MultiPlayerLevel clientLevel =
                    (net.minecraft.client.multiplayer.MultiPlayerLevel) level;
    ...
    public static <T extends Entity> List<T> getEntitiesInRadius(Level level, Vec3 center, double radius, EntityType<T> entityType) {
        ...
        return (List<T>) level.getEntities(entityType, boundingBox, entity -> true);
    }
    ...
    public static List<Entity> getEntitiesInRadius(Level level, BlockPos center, double radius) {
        return getEntitiesInRadius(level, centerOf(center), radius);
    }
    ...
    public static <T extends Entity> List<T> getEntitiesInRadius(Level level, BlockPos center, double radius, EntityType<T> entityType) {
        return getEntitiesInRadius(level, centerOf(center), radius, entityType);
    }
    ...
    public static Biome getBiomeAtPosition(Level level, Vec3 position) {
        return level.getBiome(blockPos(position));
    }
    ...
    public static boolean hasPrecipitation(Level level, Vec3 position, Biome.Precipitation precipitation) {
        return hasPrecipitation(level, blockPos(position), precipitation);
    }
    ...
    private static final class BoundingBoxMerger {
        ...
        private boolean tryCombineAdjacent(Vec3 center, AABB box) {
            for (Direction direction : Direction.values()) {
                Vec3 adjacentCenter = center.add(lowerCorner(direction.getNormal()));
    ...
    private static BlockPos blockPos(Vec3 position) {
    ...
    private static Vec3 lowerCorner(net.minecraft.core.Vec3i vec) {
