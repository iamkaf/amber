...
//?}
    ...
    public static void clearTitle(Player player) {
        if (player instanceof ServerPlayer serverPlayer) {
            ...
            //? if <=1.18.2 {
            serverPlayer.connection.send(new ClientboundSetTitleTextPacket(TextComponent.EMPTY));
            serverPlayer.connection.send(new ClientboundSetSubtitleTextPacket(TextComponent.EMPTY));
            //?} else {
